...
import { ScrollView, StyleSheet, Text, View, Image, TouchableOpacity, LayoutAnimation, Platform, UIManager } from 'react-native';
...
const Exercicios = () => {
  ...
  // Simula a conclusão de uma seção (você pode ajustar esta função conforme a lógica de conclusão real das seções)
    ...
    <ScrollView style={styles.container}>
      <View style={styles.courseContent}>
        ...
        <Text style={styles.courseSummary}>
          Este curso cobre os fundamentos da programação em Python, incluindo sintaxe, variáveis, estruturas de controle e mais.
        </Text>
        ...
        {sections.map((section) => (
          <View key={section.id}>
            <TouchableOpacity 
              ...
              <AntDesign name="play" size={24} color={completedSections.includes(section.id) ? "green" : "black"} />
            </TouchableOpacity>
          </View>
        ))}
      </View>
